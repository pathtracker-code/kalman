function out = run_single_kalman(vidid)
...
% vidid = 1
load(sprintf('single_mat/vid_%s.mat', num2str(vidid)))
X = xs;
Y = ys;
%load the tracking
...
correct = label == guess
save(sprintf('single_dist_results/position_estimates_%s.mat', num2str(vidid)), 'Q_loc_estimateX', 'Q_loc_estimateY', 'correct')
